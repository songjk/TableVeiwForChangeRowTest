...
- (void)addTopBorder
{
    [self addTopBorderWithBorderWidth:0.5 andBorderColor:[UIColor grayColor]];
}
...
{
    [self addBottomBorderWithBorderWidth:0.5 andBorderColor:[UIColor grayColor]];
}
...
- (void)addLeftBorder
{
    [self addLeftBorderWithBorderWidth:0.5 andBorderColor:[UIColor grayColor]];
}
...
- (void)addRightBorder
{
    [self addRightBorderWithBorderWidth:0.5 andBorderColor:[UIColor grayColor]];
}
